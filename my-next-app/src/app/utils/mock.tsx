const Products = [
    {
      ...
      image: ["/t-shirt1.png", "/t-shirt2.png"], // Place these in the `public` folder
    ...
    },
    {
      ...
      image: ["/product1.png", "/product2.png"], // Place these in the `public` folder
      slug: "leather-wallet",
      price: 1500,
    ...
    },
    {
      id: 3,
      title: "Running Shoes",
      image: ["/sell1.png", "/sell2.png"], // Place these in the `public` folder
      slug: "running-shoes",
      price: 3000,
      category: "Footwear",
    ...
    },
    {
      id: 4,
      title: "Smart Watch",
      image: ["/sell3.png", "/arrival-img4.png"], // Place these in the `public` folder
      slug: "smart-watch",
      price: 5000,
